    ...
    <div class="content-container">
        <div class="header-grid">
            <div class="page-header-content" data-aos="fade-right">
                ...
                <a href="/pages/contact.php" class="get-started-btn">Revolutionize Your Retail Business</a>
            </div>
            <div class="page-header-image" data-aos="fade-left">
                <img src="/assets/images/services/ecommerce-ai.svg" alt="E-commerce AI Solutions" class="animate-float">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="content-container">
        <div class="section-header">
            <div class="service-overview-header" data-aos="fade-up">
                ...
                <p class="lead">Our AI solutions help e-commerce and retail businesses create personalized shopping experiences, optimize operations, and drive revenue growth.</p>
            </div>
        </div>
        ...
        <div class="overview-grid">
            <div class="service-overview-content" data-aos="fade-up">
                <h3>The Challenge</h3>
                <p>Today's retail landscape is more competitive than ever. Consumers expect personalized experiences, seamless service, and rapid fulfillment across multiple channels. Meanwhile, retailers struggle with inventory management, pricing strategy, customer retention, and operational efficiency in an increasingly complex marketplace.</p>
            </div>
            <div class="service-overview-content" data-aos="fade-up" data-aos-delay="100">
                <h3>Our Solution</h3>
                <p>Our AI-powered retail solutions address these challenges by leveraging advanced algorithms, machine learning, and predictive analytics to optimize every aspect of your business. From personalized product recommendations to demand forecasting and fraud detection, we help you deliver exceptional customer experiences while maximizing operational efficiency and profitability.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="content-container">
        <div class="section-header">
            <div class="services-header" data-aos="fade-up">
                ...
                <p class="lead">Comprehensive AI services designed for modern retail challenges</p>
            </div>
        </div>
    ...
    <div class="content-container">
        <div class="section-header">
            <div class="implementation-header" data-aos="fade-up">
                ...
                <p class="lead">A proven methodology to successfully deploy AI in retail environments</p>
            </div>
        </div>
    ...
    <div class="content-container">
        <div class="section-header">
            <div class="case-studies-header" data-aos="fade-up">
                ...
                <p class="lead">Real-world results from our AI implementations in e-commerce and retail</p>
            </div>
        </div>
    ...
    <div class="content-container">
        <div class="section-header">
            <div class="benefits-header" data-aos="fade-up">
                ...
                <p class="lead">Transforming e-commerce and retail businesses through intelligent technology</p>
            </div>
        </div>
        ...
        <div class="benefits-grid">
            <div class="benefit-item" data-aos="fade-up">
                <div class="benefit-card">
                    ...
                    <p>Deliver personalized shopping experiences that increase customer satisfaction, loyalty, and lifetime value.</p>
                </div>
            </div>
            ...
            <div class="benefit-item" data-aos="fade-up" data-aos-delay="100">
                <div class="benefit-card">
                    ...
                    <p>Boost conversion rates, average order value, and overall revenue through personalization and optimization.</p>
                </div>
            </div>
            ...
            <div class="benefit-item" data-aos="fade-up" data-aos-delay="200">
                <div class="benefit-card">
                    ...
                    <p>Maximize profitability through intelligent pricing, inventory management, and operational efficiencies.</p>
                </div>
            </div>
            ...
            <div class="benefit-item" data-aos="fade-up" data-aos-delay="300">
                <div class="benefit-card">
                    ...
                    <p>Automate manual processes and optimize resource allocation across your retail operations.</p>
                </div>
            </div>
            ...
            <div class="benefit-item" data-aos="fade-up" data-aos-delay="400">
                <div class="benefit-card">
                    ...
                    <p>Make better business decisions based on predictive insights rather than historical reporting alone.</p>
                </div>
            </div>
            ...
            <div class="benefit-item" data-aos="fade-up" data-aos-delay="500">
                <div class="benefit-card">
                    ...
                    <p>Stay ahead of competitors by leveraging AI to create superior shopping experiences and operational excellence.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="content-container">
        <div class="section-header">
            <div class="faq-header" data-aos="fade-up">
                ...
                <p class="lead">Common questions about AI in e-commerce and retail</p>
            </div>
        </div>
